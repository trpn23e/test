...
<link href="/css/common.css?dummy=<c:out value="${time}"/>" type="text/css" rel="stylesheet"  />
...
<script>
 $(document).ready(function() {
     ...
     $("#updtDtiInterfaceNBtn").on("click", function(ev){
         ev.preventDefault();
         updtDtiInterfaceMsgStatusN();
     });
     ...
     $("#testDtiJMSBtn").on("click", function(ev){
         ev.preventDefault();
         getListToTestDtiJMS();
     });
 });
 ...
 function updtDtiInterfaceMsgStatusN () {
     var param = {
         testA: 'AAA',
         testB: 'BBB'
     };
...
<%-- <body style="background: url('/img/2037.png') no-repeat fixed 70% 25%/25% 50%;"> --%>
<body>
    ...
    <div style="float:left;width:100%;">
        <div style="float:left;width:90%;margin:0 4% 0 4%;outline:2px solid #ccc;padding:15px;">
            ...
            <br>
            <br>
            XXSB_DTI_INTERFACE 메시지 상태를 N으로 업데이트 <button id="updtDtiInterfaceNBtn">업데이트</button>
            <br>
            <br>
            <%--
            JMS 호출 테스트(Ountbound(Adaptor - Router - Connector) -> SB) : <button id="testJMSBtn">호출</button>
            <br>
            <br>
            --%>
            JMS 호출 테스트(DTI Ountbound(Adaptor - Router - Connector) -> SB) : <button id="testDtiJMSBtn">호출</button>
            <br>
            <br>
            JMS 호출 테스트(SB결과 -> Inbound Router) : <button id="sendMsgInbound">호출</button>
            <br>
            <br>
            ===============================================================
        </div>
